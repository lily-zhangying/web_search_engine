	            	...
	            	try {
		                ...
		                if(type.equals(String.class)){
		                	if(field.equals("price")){
		                		...
		                		doc.add(new TextField("manufacturer", (String)object.get(field), Field.Store.YES));
		                	}
		                	...
		                	if(field.equals("SmallImage")){
								...
								for(String smallField : (Set<String>) smallOb.keySet()){
									if(smallField.equals("FormattedPrice")){
										doc.add(new TextField("regularPrice", smallOb.get(smallField).toString(), Field.Store.YES));
									}
								}
		                	}
